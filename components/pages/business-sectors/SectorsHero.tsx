        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-lg mx-auto md:mx-0">
              Tailored digital solutions for diverse industries, designed to address your sector-specific challenges and opportunities.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button asChild size="lg" className="font-medium">
                <Link href="#industry-solutions" className="flex items-center gap-2">
                  <Building className="h-5 w-5" /> Explore Industries
                </Link>
              </Button>
          ...
          >
            <div className="relative w-full h-[400px] bg-sectors-illustration bg-contain bg-center bg-no-repeat">
