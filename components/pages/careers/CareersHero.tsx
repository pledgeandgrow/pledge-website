        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-lg mx-auto md:mx-0">
              Be part of a dynamic team dedicated to creating innovative digital solutions and making a positive impact in the industry.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button asChild size="lg" className="font-medium">
                <Link href="#open-positions" className="flex items-center gap-2">
                  <Search className="h-5 w-5" /> View Open Positions
                </Link>
              </Button>
              <Button asChild size="lg" variant="outline" className="font-medium">
                <Link href="#why-join-us" className="flex items-center gap-2">
          ...
          >
            <div className="relative w-full h-[400px] bg-careers-illustration bg-contain bg-center bg-no-repeat">
